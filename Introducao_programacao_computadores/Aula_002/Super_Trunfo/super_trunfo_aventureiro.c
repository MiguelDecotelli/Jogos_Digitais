...
int main()
{
    ...
    case 5:
        ...
        {
            printf("A densidade populacional da cidade de %s é maior que a cidade de %s: %f habitantes/km².\n", cidade1, cidade2, densidade_populacional1);
        }
    ...
    case 6:
        ...
        {
            printf("O PIB per capita de %c é maior que o PIB per capita de %c: R$ %f por habitante.\n", estado1, estado2, PIB_per_capita1);
        }
    ...
    case 7:
        ...
        {
            printf("O super poder da cidade de %s é maior que o da cidade de %s: %f.\n", cidade1, cidade2, super_poder1);
        }
